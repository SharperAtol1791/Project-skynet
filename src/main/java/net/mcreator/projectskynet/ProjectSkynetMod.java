package net.mcreator.projectskynet;
...
import net.mcreator.projectskynet.init.ProjectSkynetModTabs;
...
@Mod("project_skynet")
public class ProjectSkynetMod {
	public static final Logger LOGGER = LogManager.getLogger(ProjectSkynetMod.class);
	public static final String MODID = "project_skynet";

	public ProjectSkynetMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);

		ProjectSkynetModBlocks.REGISTRY.register(modEventBus);

		ProjectSkynetModItems.register(modEventBus);

		ProjectSkynetModTabs.REGISTRY.register(modEventBus);
